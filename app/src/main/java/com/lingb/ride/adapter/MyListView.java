...
//		setCacheColorHint(context.getResources().getColor(R.color.transparent));
		...
		headerView = (LinearLayout) inflater.inflate(R.layout.view_reflash_header, null);
...
//	                 }     
	...
	public boolean onTouchEvent(MotionEvent ev) {
		Log.i("device", "isRefrashable = " + isRefreshable);
		if (isRefreshable) {
			switch (ev.getAction()) {
...
//			lvHeaderArrowIv.startAnimation(animation);// 开始动画效果
			...
			lvHeaderTipsTv.setText(context.getString(R.string.ride_Searching));
			break;
...
//			lvHeaderArrowIv.setVisibility(View.GONE);
		...
		case DONE:
			...
			lvHeaderProgressBar.setVisibility(View.GONE);
//			lvHeaderArrowIv.clearAnimation();
//			lvHeaderArrowIv.setImageResource(R.drawable.image_app_logo);
			lvHeaderTipsTv.setText(context.getString(R.string.ride_Searching));
			lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
			break;
		}
	...
	public void onRefreshComplete() {
		state = DONE;
//		lvHeaderLastUpdatedTv.setText("Last update:" + new Date().toLocaleString());
		lvHeaderLastUpdatedTv.setText(context.getString(R.string.ride_Put_down_to_refresh));
		changeHeaderViewByState();
	}
