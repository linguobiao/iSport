...
import com.androidex.appformwork.http.entityhandler.EntityCallBack;
import com.androidex.appformwork.http.entityhandler.FileEntityHandler;
import com.androidex.appformwork.http.entityhandler.StringEntityHandler;

public class HttpHandler<T> extends AsyncTask<Object, Object, Object> implements EntityCallBack {
    /**
     * 状态值，99 正常，非99 异常
     */
    private static final String BEF_STATUS = "bef_status";
    /**
     * 服务器返回信息
     */
    private static final String BEF_MESSAGE = "bef_message";
    /**
     * 返回数据格式 protobuf/json
     */
    private static final String BEF_FORMAT = "bef_format";
    /**
     * 客户端硬版本序号
     */
    private static final String BEF_CLIENT_BUILD = "bef_client_build";
    /**
     * 后台动态配置文件序号
     */
    private static final String BEF_VERSION_BUILD = "bef_version_build";
    /**
     * 平台
     */
    private static final String BEF_PLATFORM = "bef_platform";
        ...
        if (status.getStatusCode() >= 300) {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(befStatusStr) && !"99".equals(befStatusStr)) {
                    ...
                    // 不是99将抛出异常。
                    throw new SeverRequestException(statusInt, befMsgStr);
                }
