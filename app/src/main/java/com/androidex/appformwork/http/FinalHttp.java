...
import com.androidex.appformwork.http.HttpHandler;
import com.androidex.appformwork.http.RetryHandler;
...
public class FinalHttp {
    ...
    AbsReqeustHeader mReqeustHeader;

    public FinalHttp(AbsReqeustHeader reqeustHeader)
    {

        mReqeustHeader = reqeustHeader;
        ...
        httpClient.addRequestInterceptor(new HttpRequestInterceptor()
        {
            public void process(HttpRequest request, HttpContext context) {
                ...
                // 添加请求头
                if (mReqeustHeader != null) {
                    BaseReqeustHeader.addHeaders(request, mReqeustHeader);
                }
            }
        });
