...
public abstract class AppSettings {
    ...
    //
    public IntPreference FRAMEWORK_VERSION = new IntPreference("framework_version", 0);
    public StringPreference FRAMEWORK_PACKAGE_DATA = new StringPreference("framework_package_data",
            getDefFrameworkPackageData());

    protected abstract SharedPreferences getGlobalPreferences();

    protected abstract String getDefFrameworkPackageData();
